...
This command **requires** the project directory as an argument via `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/app_spec.txt` and `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/initializer_prompt.md`

If `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/app_spec.txt`
...
**Output path:** `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/initializer_prompt.md`
...
**Output path:** `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/`!
>
> **Files created:**
> - `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/app_spec.txt`
> - `/Users/andreynovikov/tools/autocoder/generations/telegram-365-bot/prompts/initializer_prompt.md`
>
